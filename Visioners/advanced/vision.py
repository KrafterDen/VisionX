...
DEFAULT_TARGET_COLOR = "blue"
DEFAULT_ALIGN_TOLERANCE_PIXELS = 25
MIN_COLOR_AREA = 750
...
def choose_target(detections, target_color: str = DEFAULT_TARGET_COLOR):
...
def get_alignment(frame, target, tolerance: int = DEFAULT_ALIGN_TOLERANCE_PIXELS):
...
def draw_alignment(output, target, alignment, target_color: str = DEFAULT_TARGET_COLOR):
